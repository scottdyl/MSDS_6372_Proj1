...
train_split  <- sample(nrow(lifeExpec_f), size = 0.85 * nrow(lifeExpec_f))
...
make_knn_pred = function(k = 1, training, predicting) {
  pred = FNN::knn.reg(train = life_train, 
                      test = life_test, 
                      y = lifeExpec_f$Life.expectancy, k = k)$pred
  act  = lifeExpec_f$Life.expectancy
...
knn_trn_rmse = sapply(k, make_knn_pred, 
                      training = life_train, 
                      predicting = life_train$Life.expectancy)
# get requested test RMSEs
knn_tst_rmse = sapply(k, make_knn_pred, 
                      training = life_test, 
                      predicting = life_test$Life.expectancy)
